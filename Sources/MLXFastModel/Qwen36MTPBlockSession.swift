...
public final class Qwen36MTPBlockSession {
    ...
    /// verify forward. (The head is 1 layer bf16, ~2.4 ms CPU + ~0.7 ms GPU;
    /// the target is 64 layers 4-bit affine, ~4.8 ms CPU + ~11.2 ms GPU.
    /// Ratio ~0.20 matches the measured throughput breakeven.)
