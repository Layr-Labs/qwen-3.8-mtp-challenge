...
public final class Qwen36MTPBlockSession {
    ...
    public func warmAllDepths(maxDepth: Int) throws {
        ...
        // The shipped policy is statically capped at K=1. Preserve the serial
        // width-1 and live verify width-2 warms, but do not compile unreachable
        // proposal widths merely because the trusted parent can offer them.
        try warmAllDepthShapes(maxDepth: 1)
