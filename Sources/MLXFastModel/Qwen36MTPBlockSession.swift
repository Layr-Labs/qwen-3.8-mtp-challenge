...
public final class Qwen36MTPBlockSession {
    ...
    public func generateRound(depth: Int) throws -> Qwen36MTPRoundResult {
        ...
        // ~130 small state arrays into the same sync point only stalls the
        // pipeline. (The serial-control branch keeps its materialization:
        // the paired score measures exactly this differential.)
