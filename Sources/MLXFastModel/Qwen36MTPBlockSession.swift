...
public final class Qwen36MTPBlockSession {
    ...
    ///
    /// Q4 DIAGNOSTIC ARM: 0.18 is the near-control lower-cost bracket point for
    /// the promoted group-64 compact head. It keeps the shipped cold-start
    /// depth at 4 but lowers later marginal thresholds, testing whether the q4
    /// head supports modest adaptive widening without forcing an extra opening
    /// draft. Treat the official median as evidence, not a causal optimum.
