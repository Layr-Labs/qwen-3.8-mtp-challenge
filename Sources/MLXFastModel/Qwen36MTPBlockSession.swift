...
public final class Qwen36MTPBlockSession {
    ...
    private func warmAllDepthShapes(maxDepth: Int) throws {
        ...
        eval(primedDraftID)
        // VERIFY-CONCAT JIT WARM (restored onto ofou 0cd0a6b4 / 0c90733).
        // The 0cd0a6b4 REPLACE was built on 5068eb8d and evicted this loop
        // from 1cb1f43a / b0994092 (official +0.09%, parity_all_ok).
        // Scored rounds assemble verifyTokens as
        ...
        // ofou's overwrite=1 512/50 install is kept byte-identical.
