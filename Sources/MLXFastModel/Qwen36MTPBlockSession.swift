...
public final class Qwen36MTPBlockSession {
    ...
    public func generateRound(depth: Int) throws -> Qwen36MTPRoundResult {
        ...
        var (draftTop2Ids, draftTop2Values) =
            Self.linearTopTwoRows(model.applyDraftLMHead(draftHidden))
        var draftId = model.mapDraftTokenIds(
            draftTop2Ids[0..., 0 ..< 1])
        draftIdArrays.append(draftId)
        draftMarginArrays.append(draftTop2Values)
