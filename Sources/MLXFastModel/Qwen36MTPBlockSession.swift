...
public final class Qwen36MTPBlockSession {
    ...
    private static func warmTargetLaterWindowSDPA(_ cache: [KVCache]) {
        ...
        var outs: [MLXArray] = []
        // Restores 0dd455f0's validated qL{1..5} extension (receipt 3.2355→3.2414
        // in its note), removed by b40c28e's stale-base overlay. qL∈{2,3} are
        // dispatched as chunk-B of width-7/8 verifies (see AttentionUtils exactness chunk).
        for qL in [1, 2, 3, 4, 5] {
