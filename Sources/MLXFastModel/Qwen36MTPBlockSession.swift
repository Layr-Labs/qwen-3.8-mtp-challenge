...
public final class Qwen36MTPBlockSession {
    ...
    /// 0.60 measured -1% (over-strict ramp, 16 rounds); the first remote
    /// exploration at 0.18 scored below the incumbent, so 0.22 tests the
    /// conservative side of the fitted 0.20 value without changing the
    /// acceptance or cache machinery.
    private static let headStepCostRatio = 0.22
