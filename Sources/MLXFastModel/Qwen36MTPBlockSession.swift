...
public final class Qwen36MTPBlockSession {
    ...
    private static func warmTargetLaterWindowSDPA(_ cache: [KVCache]) {
        ...
        // 128-block family at kL=1025 for the same qL={1,2,3,4,5}: the
        // exactness chunk fires chunk-B at qL=W-5 (qL=2 at width 7, qL=3 at
        // width 8) mid-window once N>1024, so those widths must not cold-JIT
