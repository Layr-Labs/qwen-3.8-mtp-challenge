...
public protocol Qwen36MTPTarget: AnyObject {
    ...
    /// One-time head requantization for cheaper drafting (fc + MLP to
    /// affine-4 g64, attention stays bf16). Draft side; run outside every
    /// scored window.
    func prepareMTPHeadForDrafting()
