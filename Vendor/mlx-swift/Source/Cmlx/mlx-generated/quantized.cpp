    ...
    if (out_vec_size >= 4096) {
      ...
      switch (ntg.x) {
        ...
        case 7:
          ...
          return;
        case 8:
          // 2+2+2+2, not 3+3+2 or 4+4 -- see quantized.h for the register-cliff
          // rationale, the row-independence exactness argument, and the
          // streak-gate synergy. This JIT twin is the runtime-effective source.
