...
/// Test seam: when true, the fused head pre-stage (`qwen35_mtp_pre_fuse`)
/// and the fused SwiGLU tail (`qwen35_mtp_swiglu`) decline every call so
...
public nonisolated(unsafe) var _qwen35MTPFusionStats: (preFuse: Int, swiglu: Int) =
    (0, 0)
