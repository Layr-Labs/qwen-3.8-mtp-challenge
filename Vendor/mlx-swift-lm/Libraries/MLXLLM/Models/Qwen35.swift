...
public class Qwen35TextModelInner: Module {
    ...
    func callAsFunction(
        ...
        // Decode-width asyncEval ladder: at S <= 5 (serial step / streak-ladder
        // MTP verify) the host builds a ~64-layer graph before anything reaches
        ...
        let ladderActive = inputs.dim(1) <= 5
