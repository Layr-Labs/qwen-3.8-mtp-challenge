...
// Adapted from the public Yukon MLX Fast PR #250 implementation by
// machalabs-ai; retained under this repository's MIT license.
...
public class Qwen35TextModelInner: Module {
    ...
    func callAsFunction(
        ...
        // Candidate-only densification from public Yukon MLX Fast PR #250:
        // verify widths 3..9 fire asyncEval on a
